...
const Professions = () => {
  return (
    <div className='bg-primary flex flex-col gap-5 items-center p-[8%]'>
        <h3>MEDICAL AND ALLIED PROFESSIONS IN AUSTRALIA</h3>
        <p className=''>Navigating the path to a medical career in Australia as an international graduate can be complex. This guide provides a comprehensive overview of the eligibility criteria, exam requirements, and conversion procedures for international medical licenses.</p>
